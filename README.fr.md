...
> --lang | -l               # Sélection de la langue (en, fr)
...
Version 1.1.0 :
- Ajout de l'argument `--lang | -l` pour la sélection de la langue (en, fr)
- Mise à jour de l'interface Gum pour inclure la sélection de la langue
- Mise à jour de la documentation (README.md, README.fr.md)
- Corrections de bugs mineurs et améliorations des scripts
